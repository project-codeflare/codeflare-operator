...
| Component                    | Version                                                                                           |
|------------------------------|---------------------------------------------------------------------------------------------------|
| CodeFlare Operator           | [v1.4.4](https://github.com/project-codeflare/codeflare-operator/releases/tag/v1.4.4)             |
| CodeFlare-SDK                | [v0.16.4](https://github.com/project-codeflare/codeflare-sdk/releases/tag/v0.16.4)                |
| AppWrapper                   | [v0.13.1](https://github.com/project-codeflare/appwrapper/releases/tag/v0.13.1)                   |
