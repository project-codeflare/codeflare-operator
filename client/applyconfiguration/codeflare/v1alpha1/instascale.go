...
// InstaScaleApplyConfiguration represents an declarative configuration of the InstaScale type for use
// with apply.
...
// InstaScale constructs an declarative configuration of the InstaScale type for use with
// apply.
func InstaScale(name, namespace string) *InstaScaleApplyConfiguration {
	b := &InstaScaleApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("InstaScale")
	b.WithAPIVersion("codeflare.codeflare.dev/v1alpha1")
	return b
}
...
func (b *InstaScaleApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
